...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/3.5.12/reference/io/caching.html)
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.5.12/reference/web/spring-security.html#web.security.oauth2.server)
